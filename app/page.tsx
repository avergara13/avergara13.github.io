      ...
      <section className="supporting-section">
        <div className="shell">
          ...
          <div className="project-grid">
              <Link className="project-card dark-card wide-card loft-plate" href="/work/loft-os"><div className="loft-plate-copy"><span className="card-tag">First-tier proof · sanitized architecture case study</span><h3>Loft OS</h3><p>Role-specific AI workflows coordinated through clear handoffs, human review, evidence, recovery, and accountable closeout.</p><HumanGatedHandoff variant="dark" /><span className="card-link">Open case study →</span></div><div className="mini-workflow" aria-label="Loft OS proof sequence"><div><span>01 · Scope</span><b>Bound the work</b></div><div><span>02 · Review</span><b>Keep judgment visible</b></div><div><span>03 · Close</span><b>Reconcile evidence</b></div></div></Link>
