...
export const metadata: Metadata = { title: "Work Index — Angel Vergara", description: "Evidence-backed project and case-study index for Angel Vergara.", alternates: { canonical: "/work/" }, openGraph: { type: "website", url: "/work/", title: "Work Index — Angel Vergara", description: "Evidence-backed project and case-study index: governed AI systems, product implementation, workflow logic, and domain translation.", images: [{ url: "/og-home.png", width: 1200, height: 630, alt: "Angel Vergara work index" }] }, twitter: { card: "summary_large_image", title: "Work Index — Angel Vergara", description: "Evidence-backed project and case-study index: governed AI systems, product implementation, workflow logic, and domain translation.", images: ["/og-home.png"] } };

const work = [
  { number: "01", title: "Loft OS", href: "/work/loft-os/", type: "Governed multi-agent workflow orchestration", role: "Architecture / orchestration / governance", status: "Sanitized case study", proof: "Systems Field Manual: scoped intake, role-separated execution, human approval, evidence, recovery, and accountable closeout.", image: "/og-loft-os.png", alt: "Loft OS public-safe systems architecture card" },
  { number: "02", title: "Resale Scanner Pro", href: "/work/resale-scanner-pro/", type: "Working product", role: "Product / workflow / implementation", status: "In operating use", proof: "Real mobile workflow connecting capture, research, human judgment, and operating evidence.", image: "/images/rsp/session.png", alt: "Resale Scanner Pro mobile session interface" },
...
export default function WorkIndex() {
  return <main id="main" data-section="work-index">
    <section className="work-index shell">
      <header><h1>Evidence Atlas</h1><p>Formal proof surfaces showing governed AI systems, product implementation, workflow logic, and domain translation.</p></header>
